...
export default function AdminSidebar() {
  ...
  const menuItems = [
    ...
    { labelAr: 'إدارة الجلسات', labelEn: 'Sessions', href: '/admin/sessions', icon: CalendarDays },
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-all font-cairo ${
                      isActive
            ...
            <div className="flex items-center gap-3 flex-row-reverse">
              ...
              {!collapsed && (
                <div className="text-right">
                  <p className="text-gold text-sm font-cairo font-semibold">مكتب مريم بنت محمد</p>
                  <p className="text-[11px] text-gray-500 font-cairo">للمحاماة والاستشارات القانونية</p>
                </div>
              )}
            </div>
          </div>

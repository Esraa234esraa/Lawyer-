          ...
          <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            >
              ...
              <div className="mb-8">
                ...
                <p className="text-gray-300 font-cairo">{internshipData.duration}</p>
              </div>
              ...
              <div className="mb-8">
                ...
                <ul className="space-y-2">
                  {internshipData.requirements.map((req, idx) => (
                    <li
                      key={idx}
                      className="text-gray-300 font-cairo flex items-center gap-2 justify-end"
                    >
                      <span>{req}</span>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {internshipData.benefits.map((benefit, idx) => (
                    <li
                      key={idx}
                      className="text-gray-300 font-cairo flex items-center gap-2 justify-end"
                    >

...
export default function AdminDashboard() {
  return (
    <div dir="rtl" className="min-h-screen flex justify-center bg-charcoal font-cairo">
      ...
      >
        ...
        {/* Welcome Text */}
        <h1 className="text-3xl mt-4 md:text-4xl font-bold text-gold mb-4">
          مرحباً بك في لوحة التحكم 👋
        </h1>

        <p className="text-gray-300 text-base md:text-lg leading-7">
          هنا يمكنك إدارة الخدمات، القضايا، العملاء وكل بيانات النظام بسهولة وبشكل منظم.
        </p>
